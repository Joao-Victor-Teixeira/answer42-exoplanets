package com.joaodev.answer42_exoplanets.domain.entities;
...
public class Exoplanets {
    ...
    public Exoplanets(String id, String pl_name, String hostname, Integer disc_year, String disc_facility,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        Exoplanets other = (Exoplanets) obj;
        if (id == null) {
            if (other.id != null)
                return false;
